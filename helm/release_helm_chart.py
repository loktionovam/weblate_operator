...
chart_path = os.path.join(script_path, "charts/weblate-operator")
chart_info_path = os.path.join(chart_path, "Chart.yaml")

chart_values_path = os.path.join(chart_path, "values.yaml")

app_version = os.environ.get("WEBLATE_OPERATOR_IMAGE_TAG", "v0.1.0")
app_image = os.environ.get("WEBLATE_OPERATOR_IMAGE_NAME", "loktionovam/weblate_operator")
